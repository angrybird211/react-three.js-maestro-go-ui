...
const MonoMicApplication = props => {
    ...
    const nodeColor = (node) => {
        ...
        if (node.category === 'dataset' || node.category === 'app') return "#0a525d";
        return "#091425";
    }
    ...
    const handleNodeClick = node => {
        if (node.category === "dataset") {
            ...
            setActiveDataset(data.datasets[node.groupID - 1]);
                ...
                <div className="page-content w-100">
                    ...
                    <div className="d-flex">
                        <div className="intelBar">
                            ...
                            <Link className="link active" to="/MonoMic/dataset/1">
                                <span>
                        ...
                        >
                            ...
                            </div>
                            {
                                activeDataset ?
                                    <div className="modal-body">
                                        <p>App ID: &nbsp;{activeDataset.appID}</p>
                                        <p>Service Name: &nbsp;{activeDataset.name}</p>
                                        <p>Resources: <br />
                                            &nbsp;&nbsp;Limits: &nbsp;&nbsp;CPU: {activeDataset.resources.limits.cpu} &nbsp;&nbsp;Memory: {activeDataset.resources.limits.memory}<br />
                                            &nbsp;&nbsp;Requests: &nbsp;&nbsp;CPU: {activeDataset.resources.requests.cpu} &nbsp;&nbsp;Memory: {activeDataset.resources.requests.memory}</p>
                                    </div> : ""
                            }
                        </Modal>
