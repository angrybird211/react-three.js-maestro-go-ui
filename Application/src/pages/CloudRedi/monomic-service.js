...
const MonoMicApplication = props => {
    ...
    const nodeColor = (node) => {
        ...
        if (node.category === 'service' || node.category === 'app') return "#0a525d";
        return "#091425";
    }
    ...
    const handleNodeClick = node => {
        if (node.category === "service") {
            ...
            setActiveService(data.services[node.groupID - 1]);
                ...
                <div className="page-content w-100">
                    ...
                    <div className="d-flex">
                        <div className="intelBar">
                            ...
                            <Link className="link active" to="/MonoMic/service/1">
                                <span>
                        ...
                        >
                            ...
                            </div>
                            {
                                activeService ?
                                    <div className="modal-body">
                                        <p>App ID: &nbsp;{activeService.appID}</p>
                                        <p>Service Name: &nbsp;{activeService.name}</p>
                                        <p>Host ID: &nbsp;{activeService.hostID}</p>
                                        <p>Resources: <br />
                                            &nbsp;&nbsp;Limits: &nbsp;&nbsp;CPU: {activeService.resources.limits.cpu} &nbsp;&nbsp;Memory: {activeService.resources.limits.memory}<br />
                                            &nbsp;&nbsp;Requests: &nbsp;&nbsp;CPU: {activeService.resources.requests.cpu} &nbsp;&nbsp;Memory: {activeService.resources.requests.memory}</p>
                                    </div> : ""
                            }
                        </Modal>
