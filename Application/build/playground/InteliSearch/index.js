  ...
  function App() {
    ...
    const endPointResults = results.map(endPoint => endPoint.item);
        ...
        <main className="container">
          <ul className="endPoints">
            {endPointResults.map(endPoint => {
              const { name, company, species, thumb } = endPoint;
              return (
                <li key={name} className="endPoint">
                  <span className="endPoint-thumb" style={{
                    backgroundImage: `url(${thumb})`
                  }} />
                  <ul className="endPoint-meta">

                    <li><strong>Label</strong> { cisco.asa.source_interface } </li>
                    ...
                    <li><strong>Label</strong> { process.pid } </li>
